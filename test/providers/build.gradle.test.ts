...
describe('Gradle build.gradle parser tests', () => {
    ...
    it('tests empty build.gradle', async () => {
        const deps = await dependencyProvider.collect(``);
        expect(deps).is.eql([]);
    });

    it('tests build.gradle with string notation dependencies', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle with map notation dependencies', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle with comments', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { // a second comment
    ...
    it('tests build.gradle with empty lines', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle with spaces before and after package parameters', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle with arguments', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle with single line dependency declarations', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { implementation group: "log4j", name: "log4j", version: "1.2.3" }
    ...
    it('tests build.gradle with muliple dependency declarations', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies 
{
    ...
    it('tests build.gradle with special dependency declarations', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
...
dependencies { 
    ...
    it('tests build.gradle dependencies with missing version parameter', async () => {
        const deps = await dependencyProvider.collect(`
plugins {
    id 'java'
}
